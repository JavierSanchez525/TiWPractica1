            ...
            <div class="wrap">
                ...
                <form action="controlador" method="post" name="adminModifyProduct" id="adminModifyProduct-form" enctype="multipart/form-data">
                	<div class="wrap">
    	 				...
    	 				<div class="col_1_of_2 span_1_of_2">
    	 					<div><input required type="password" placeholder="Contraseña de administrador" name="adminPassword" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contraseña de administrador';}"></div>
    	 				</div>
    	 			</div>
    				<div class="clear"></div>
    			</form>
          			...
          			<div class="wrap">
    		   			<form action="controlador" method="post" name="adminDeleteProduct" id="adminDeleteProduct-form">
    			 			<div class="col_1_of_2 span_1_of_2">
		    	  			...
		    	  			<div class="col_1_of_2 span_1_of_2">	
		    					<div><input required type="password" placeholder="Contraseña de administrador" name="adminPassword" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contraseña de admin';}"></div>		           				
